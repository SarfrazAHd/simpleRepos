...
title = Label(TitleFrame, text="Student Database Management System", font=('arial', 35, 'bold'), width=43, bg="#C2B7B3", fg="brown", bd=2, relief=RIDGE)
...
Student_id = Label(DataFrameLeft, font=('arial', 13, 'bold'), text="Student Id ", fg='#31415c', padx=4, pady=6, bg="Ghost White")
...
Student_name = Label(DataFrameLeft, font=('arial', 13, 'bold'), text="Student Name ", fg='#31415c', padx=4, pady=6, bg="Ghost White")
...
Student_last_name = Label(DataFrameLeft, font=('arial', 13, 'bold'), text="Last Name ", fg='#31415c', padx=4, pady=6, bg="Ghost White")
...
Student_birth = Label(DataFrameLeft, font=('arial', 13, 'bold'), fg='#31415c', text="Date of Birth ", padx=4, pady=6,bg="Ghost White")
...
Student_programme = Label(DataFrameLeft, font=('arial', 13, 'bold'), fg='#31415c', text="Programme", padx=4, pady=6, bg="Ghost White")
...
Student_branch = Label(DataFrameLeft, font=('arial', 13, 'bold'), fg='#31415c', text="Branch", padx=4, pady=6, bg="Ghost White")
...
Student_address = Label(DataFrameLeft, font=('arial', 13, 'bold'), fg='#31415c', text="Address", padx=4, pady=6, bg="Ghost White")
...
Student_email = Label(DataFrameLeft, font=('arial', 13, 'bold'), fg='#31415c', text="Email", padx=4, pady=6,bg="Ghost White")
...
Student_phone = Label(DataFrameLeft, font=('arial', 13, 'bold'), fg='#31415c', text="Phone Number", padx=4, pady=6,bg="Ghost White")
...
list_box = Listbox(DataFrameRight, width=50, yscrollcommand=scrollbar.set, height=20,font=('arial', 11, 'bold'), fg='#250F00')
...
btn1 = Button(btnFrame, text="Add New", font=('times new roman', 13, 'bold'), bg='#419C71', fg='white', padx=10, pady=5,
...
btn2 = Button(btnFrame, text="Display", font=('times new roman', 13, 'bold'), bg='#419C71', fg='white', padx=10, pady=5,
              width=10, relief=RIDGE,
              command=display)
...
btn3 = Button(btnFrame, text="Clear", font=('times new roman', 13, 'bold'), bg='#419C71', fg='white', padx=10, pady=5,
              width=10, relief=RIDGE,
              command=clear)
...
def delete():
    ...
    if id == "" or Firstname == "" or lastname == "" or birth == "" or programme == "" or branch == "" or address == "" or email == "" or phone == "":
        tkinter.messagebox.showwarning("Warning!", "No data for Deletion")
    else:
        deletion = tkinter.messagebox.askyesno("Delete", "Are you sure you want to delete ?")

        if deletion > 0:
            sql = "DELETE FROM Student_db WHERE SID LIKE?"
            curs.execute(sql, (Student_id_entry.get(),))
            con.commit()
...
btn5 = Button(btnFrame, text="Search", font=('times new roman', 13, 'bold'), bg='#419C71', fg='white', padx=10, pady=5,
              width=10, relief=RIDGE,
              command=search)
...
btn6 = Button(btnFrame, text="Update", font=('times new roman', 13, 'bold'), bg='#419C71', fg='white', padx=10, pady=5,
              width=10, relief=RIDGE,
              command=update)
...
btn7 = Button(btnFrame, text="Exit ", font=('times new roman', 13, 'bold'), bg='#419C71', fg='white', padx=10, pady=5,
              width=10, relief=RIDGE,
              command=exit)
