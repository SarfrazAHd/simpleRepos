...
def update_appointment():
    ...
    def update():
        ...
        tkinter.messagebox.showinfo("Update", "Updated succesfuly")
    ...
    def delete():
        ...
        tkinter.messagebox.showinfo("Delete", "Deleted succesfuly")
...
btn=Button(root,font=('times new roman',11,'bold'),text="Search",width=7,fg='white',height=1,bg="steelblue",command=update_appointment)
